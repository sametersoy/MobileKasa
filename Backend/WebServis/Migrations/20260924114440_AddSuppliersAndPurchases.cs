        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumentNo = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Note = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseItems_StoreProducts_StoreProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseItems_StoreProductId",
                table: "PurchaseItems",
                column: "StoreProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_StoreId_CreatedAt",
                table: "Purchases",
