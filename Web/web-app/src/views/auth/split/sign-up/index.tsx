          ...
          <Card className="auth-box-form border-0 mb-0">
            <CardBody className="min-vh-100 d-flex flex-column justify-content-center">
              ...
              <div className="mt-auto text-center">
                <h4 className="fw-bold">Yeni Hesap Oluştur</h4>
                <p className="text-muted auth-sub-text mx-auto">
                  Yönetim panelinize erişmek için yönetici hesabı oluşturun.
                </p>
                <RegisterForm />
              </div>
              <p className="text-muted text-center mt-4 mb-0">
                Zaten hesabınız var mı?&nbsp;
                <Link to="/" className="text-decoration-underline link-offset-3 fw-semibold">
                  Giriş Yap
                </Link>
              </p>
