...
export const forumPostData: ForumPostType[] = [
  {
    ...
    votes: 732,
    timeLeft: '3 days',
    badge: { className: 'text-bg-success', text: 'New' },
  },
  {
    category: 'AI & Ethics',
    ...
    votes: 894,
    timeLeft: '4 days',
    badge: { className: 'text-bg-warning', text: '23' },
  },
  {
    ...
    votes: 410,
    timeLeft: '2 days',
    badge: { className: 'text-bg-info', text: '8' },
  },
  {
    ...
    votes: 612,
    timeLeft: '1 day',
    badge: { className: 'text-bg-primary', text: '12' },
  },
  {
    category: 'DevOps',
    ...
    votes: 1005,
    timeLeft: '6 days',
    badge: { className: 'text-bg-secondary', text: '18' },
  },
  {
    ...
    votes: 558,
    timeLeft: '7 days',
    badge: { className: 'text-bg-dark', text: '7' },
  },
]
