  ...
  series: [
    {
      ...
      center: ['50%', '50%'],
      data: [
        { value: 1200, name: 'Facebook', itemStyle: { color: getColor('chart-primary') } },
        {
          value: 1000,
          name: 'Youtube',
          itemStyle: { color: getColor('chart-beta') },
        },
        { value: 800, name: 'Twitter', itemStyle: { color: getColor('chart-delta') } },
        {
          value: 600,
          name: 'Linkedin',
          itemStyle: { color: getColor('chart-secondary') },
        },
        { value: 400, name: 'Github', itemStyle: { color: getColor('chart-gamma') } },
      ],
      emphasis: {
        itemStyle: {
          shadowBlur: 10,
  ...
  series: [
    {
      ...
      data: [
        { value: 1200, name: 'FB', itemStyle: { color: getColor('chart-primary') } },
        {
          value: 1000,
          name: 'YT',
          itemStyle: { color: getColor('chart-alpha') },
        },
        { value: 800, name: 'TX', itemStyle: { color: getColor('chart-delta') } },
        {
          value: 600,
          name: 'LD',
          itemStyle: { color: getColor('chart-secondary') },
        },
        { value: 400, name: 'GT', itemStyle: { color: getColor('chart-beta') } },
      ],
    },
  ],
  tooltip: {
  ...
  series: [
    {
      ...
      data: [
        { value: 1200, name: 'Starter', itemStyle: { color: getColor('chart-primary') } },
        {
          value: 1000,
          name: 'Basic',
          itemStyle: { color: getColor('chart-alpha') },
        },
        { value: 800, name: 'Optimal', itemStyle: { color: getColor('chart-delta') } },
        {
          value: 600,
          name: 'Business',
          itemStyle: { color: getColor('chart-secondary') },
        },
        { value: 400, name: 'Premium', itemStyle: { color: getColor('chart-beta') } },
      ],
    },
  ],
  tooltip: {
...
const leftChartData = [
  { value: 1048, name: 'Starter', itemStyle: { color: getColor('chart-alpha') } },
  {
    value: 735,
    name: 'Basic',
    itemStyle: { color: getColor('chart-primary') },
  },
  { value: 580, name: 'Optimal', itemStyle: { color: getColor('chart-secondary') } },
  {
    value: 484,
    name: 'Business',
    itemStyle: { color: getColor('chart-beta') },
  },
  { value: 300, name: 'Premium', itemStyle: { color: getColor('chart-gamma') } },
  {
    value: 300,
    name: 'Platinum',
...
const rightChartData = [
  { value: 1048, name: 'Facebook', itemStyle: { color: getColor('chart-primary') } },
  {
    value: 735,
    name: 'Youtube',
    itemStyle: { color: getColor('chart-gamma') },
  },
  { value: 580, name: 'Twitter', itemStyle: { color: getColor('chart-delta') } },
  {
    value: 484,
    name: 'Linkedin',
    itemStyle: { color: getColor('chart-secondary') },
...
const data = [
  { value: 850, name: 'Starter', itemStyle: { color: getColor('chart-primary') } },
  {
    value: 750,
    name: 'Starter Pro',
    itemStyle: { color: getColor('chart-secondary') },
  ...
  { value: 447, name: 'Business', itemStyle: { color: getColor('chart-beta') } },
  {
    value: 682,
