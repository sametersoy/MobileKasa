  ...
  series: [
    {
      ...
      animation: true,
      itemStyle: {
        color: getColor('chart-primary-rgb', 0.75),
    ...
    series: [
      {
        ...
        barWidth: '15px',
        barGap: '0.25',
        itemStyle: { color: getColor('chart-primary'), borderRadius: [3, 3, 0, 0] },
      },
      {
        ...
        barWidth: '15px',
        barGap: '0.25',
        itemStyle: { color: getColor('chart-delta'), borderRadius: [3, 3, 0, 0] },
      },
      {
        ...
        barWidth: '15px',
        barGap: '0.25',
        itemStyle: { color: getColor('chart-gamma'), borderRadius: [3, 3, 0, 0] },
      },
    ],
    grid: {
      top: '10%',
