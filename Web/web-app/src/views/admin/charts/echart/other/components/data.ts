...
export const getNestedPieChart = (): EChartsOption => ({
  ...
  series: [
    ...
    },
    {
      ...
      data: [
        { value: 1048, name: 'Baidu', itemStyle: { color: getColor('chart-primary') } },
        {
          value: 335,
          name: 'Direct',
          itemStyle: { color: getColor('chart-secondary') },
        },
        { value: 310, name: 'Email', itemStyle: { color: getColor('chart-delta') } },
        {
          value: 251,
          name: 'Google',
          itemStyle: { color: getColor('chart-beta') },
        },
        { value: 234, name: 'Union Ads', itemStyle: { color: getColor('chart-alpha') } },
        {
          value: 147,
          name: 'Bing',
          itemStyle: { color: getColor('chart-zeta') },
        },
        { value: 135, name: 'Video Ads', itemStyle: { color: getColor('chart-dark') } },
        {
          value: 102,
          name: 'Others',
