  ...
  series: [
    {
      ...
      pointer: { show: false },
      center: ['50%', '50%'],
      progress: { show: true, overlap: false, roundCap: true, clip: false, itemStyle: { color: getColor('chart-delta') } },
    ...
    },
    {
      ...
      pointer: { show: false },
      center: ['50%', '50%'],
      progress: { show: true, overlap: false, roundCap: true, clip: false, itemStyle: { color: getColor('chart-primary') } },
      axisLine: { lineStyle: { width: 8, color: [[1, getColor('light')]] } },
      splitLine: { show: false },
      axisTick: { show: false },
      axisLabel: { show: false },
    ...
    },
    {
      ...
      pointer: { show: false },
      center: ['50%', '50%'],
      progress: { show: true, overlap: false, roundCap: true, clip: false, itemStyle: { color: getColor('chart-alpha') } },
      axisLine: { lineStyle: { width: 8, color: [[1, getColor('light')]] } },
      splitLine: { show: false },
      axisTick: { show: false },
      axisLabel: { show: false },
