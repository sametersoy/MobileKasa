          ...
          <Col sm={6} className="text-center">
            <div className="avatar avatar-xl mx-auto">
              <span className="avatar-title bg-purple-subtle text-purple rounded-circle fw-bold">
                <Icon icon="user-circle" className="text-purple fs-28 fill-purple" />
              </span>
            </div>
            ...
            <Link to="/auth/sign-up" className="link-primary text-decoration-underline fw-semibold link-offset-3">
              Create Your Account
            </Link>
          </Col>
        </Row>
