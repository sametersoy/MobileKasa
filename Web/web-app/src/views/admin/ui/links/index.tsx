...
const LinkUtilities = () => {
  return (
    <Card>
      ...
      <CardBody>
        <p className="text-muted">
          <Link to="/ui/utilities">Colored link helpers</Link> have been updated to pair with our link utilities. Use the new utilities to modify the link opacity, underline opacity, and underline offset.
        </p>
        {colorVariants.slice(0, 6).map((item, idx) => (
          <p key={idx}>
