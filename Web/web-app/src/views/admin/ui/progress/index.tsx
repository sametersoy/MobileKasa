        ...
        <Row>
          <Col lg={12}>
            <Card>
              ...
              <CardBody>
                <p className="text-muted mb-2">Documentation and examples for using React Bootstrap custom progress bars featuring support for stacked bars, animated backgrounds, and text labels.</p>
                <Link className="btn btn-link p-0" to="https://react-bootstrap.netlify.app/docs/components/progress" target="_blank">
...
const HeightProgressBar = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Height</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
...
const MultipleBars = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Multiple bars</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
...
const AnimatedStripes = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Animated stripes</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const LabelsBar = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Labels</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const BackgroundBar = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Backgrounds</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
...
const StripedBar = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Striped</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const StepsProgressBar = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Steps</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
