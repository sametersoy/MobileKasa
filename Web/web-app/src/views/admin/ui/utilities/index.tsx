...
const TextOpacityColor = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle>Text Opacity Color</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
...
const Opacity = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Opacity</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const PointerEvents = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Pointer Events</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const BorderRadiusSize = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Border Radius Size</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const TextSelection = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Text Selection</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const Overflow = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Overflow</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const PositionInArrange = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Position in Arrange</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const PositionInCenter = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Position in Center</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const PositionInAxis = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Position in Axis</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const Shadows = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Shadows</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const ObjectFit = () => {
  return (
    <Card>
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Object Fit</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
...
const Zindex = () => {
  return (
    <Card title="Z-index">
      <CardHeader>
        <div className="flex-grow-1">
          <CardTitle as="h4">Z-index</CardTitle>
        </div>
      </CardHeader>
      <CardBody>
        <p className="text-muted">
