  ...
  return (
    <>
      ...
      <Card>
        ...
        <CardBody>
          <p className="text-muted mb-2">Bootstrap’s cards provide a flexible and extensible content container with multiple variants and options.</p>
...
const CardWithActionTools = () => {
  return (
    <Card>
      <CardHeader as="h5">Card with Action Tools</CardHeader>
      <CardBody>
        <p className="card-text">With supporting text below as a natural lead-in to additional content.</p>
        <Link to="" className="btn btn-sm btn-primary">
          Go somewhere
