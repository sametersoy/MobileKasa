...
import { Text, CardReport01, PickerSelect } from '@/components';
...
const CardReport01Review = () => {
  ...
  return (
    <Container title={'CardReport01 Component'}>
      <View style={styles.container}>
        <Text footnote bold>
          Demo
        </Text>
        <View style={[styles.item, { alignContent: 'center', alignItems: 'center' }]}>
          <CardReport01 style={{ width: '50%' }} icon={icon.key} title={title} price={price} onPress={onPress} />
        </View>
        ...
        <View style={styles.example}>
          ...
          <View style={styles.row}>
            <View style={styles.left}>
              <CardReport01 disabled icon="arrow-up" title={'Income'} price="$500,290" onPress={onPress} />
            </View>
            <View style={styles.right}>
              <CardReport01 disabled icon="arrow-down" title={'Expense'} price="$350,120" onPress={onPress} />
            </View>
          </View>
        </View>
      </View>
...
export default CardReport01Review;
